...
class SIReader(object):
    ...
    def _connect_reader(self, port):
        ...
        """
        #EPJ extend to support a TCP connection Jan 2016.
        if 'socket' in port:
            try:
                self._serial = serial_for_url(port)
            except:
            ...
            raise SIReaderException("Unrecognized port name '%s'" % port)
    ...
    def _read_command(self, timeout = None):
        ...
        try:
            ...
            #EPJ not sure what this is, only used here, skip?
...
class SIReaderControl(SIReader):
    ...
    def poll_punch(self):
        ...
        while True:
            ...
            punches.append( (self.station_code,
